...
def loaddata(self):
    ...
    self.emailtextfield.setText(gest.email)
...
def validate(self):
    try:
        ...
        if email == "":
            ...
            msg.setText("Veuillez saisir d'abord un email.")
            ...
            # start the app
            retval = msg.exec_()
        elif email == gest.email:
            msg = QMessageBox()
            msg.setIcon(QMessageBox.Critical)

            # setting message for Message Box
            msg.setText("Vous n'avez effectuer aucun changement. Veuillez changer l'emai ou cliquer sur le boutton retour.")
            ...
            request = f"UPDATE `gestionstock`.`gestionnaire` SET `email` = '{email}' WHERE (`idgestionnaire` = '{Ui_Form.gestid}')"
            ...
            # setting message for Message Box
            msg.setText("Votre email a été changé avec succès.")
...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.emailtextfield = QtWidgets.QLineEdit(Form)
        self.emailtextfield.setGeometry(QtCore.QRect(370, 280, 241, 31))
        font = QtGui.QFont()
        font.setPointSize(13)
        self.emailtextfield.setFont(font)
        self.emailtextfield.setStyleSheet("border-radius:4px")
        self.emailtextfield.setObjectName("emailtextfield")

        self.pushButton_2 = QtWidgets.QPushButton(Form)
        self.pushButton_2.setGeometry(QtCore.QRect(630, 280, 26, 26))
    ...
    def retranslateUi(self, Form):
        ...
        self.nomLabel.setText(_translate("Form", "Omaima "))
